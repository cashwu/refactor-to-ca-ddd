...
@EnableJpaRepositories(basePackages = {"tw.teddysoft.tasks"},
...
public class ToDoListDataSourceConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean toDoListTransactionManager(EntityManagerFactoryBuilder builder) {
        return builder
